...
public class CodeCommentsService {
    ...
    // 특정 Issue의 코멘트 조회
    public ResponseEntity<List<ResGetCodeCommentsDto>> getAllCodeCommentsByCodeId(Long iid) {
    ...
    // 예외처리 임시적용
    @Transactional
    public ResponseEntity<ResGetCodeCommentsDto> addCodeComments(ReqAddCodeCommentsDto request) {
        try {
